...
#SingleR uses reference expression data from purified cell types (e.g., from BlueprintEncode, HumanPrimaryCellAtlas, or your own bulk RNA-seq data) to assign cell type labels to each single cell in your scRNA-seq dataset.
# setwd("~/Desktop/demo/singleCell_singleR/scripts")
# Data : https://www.10xgenomics.com/datasets/20-k-human-pbm-cs-3-ht-v-3-1-chromium-x-3-1-high-6-1-0
library(SingleR)
library(celldex)
library(Seurat)
library(tidyverse)
